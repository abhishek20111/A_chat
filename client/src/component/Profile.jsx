...
import { addFriend, getProfile, setConversation } from '../service/api';
...
export default function Profile() {
    ...
    const handleAddFriend = async (e, Fri_ID) => {
        ...
        try {
            ...
            const res = await setConversation(data);
            notify1(res.data.message);
            navigate('/whatsapp');
        } catch (error) {
            console.error('Error setting up conversation:', error);
            notify4('Error setting up conversation');
        }
    };
                ...
                <div class="border-b px-4 pb-6">
                    <div class="text-center my-4">
                        <img
                            ...
                            src={`${userData ? userData.photo || 'https://randomuser.me/api/portraits/women/21.jpg' : 'https://randomuser.me/api/portraits/women/21.jpg'}`}
                            alt=""
                        />
                    ...
                    <div class="flex gap-2 px-2">
                        {userId != id ? <button onClick={(e) => handleAddFriend(e, userData.id)}
                    ...
                    <div class="flex gap-2 items-center text-gray-800 dark:text-gray-300 mb-4">
                        ...
                        <span>
                            <strong className="text-black dark:text-white">
                                {userData && userData.friend ? userData.friend.length : 0}
                            </strong> Followers you know
                        </span>
                    </div>
                    <div class="flex">
                        <div class="flex justify-end mr-2">
                            ...
                            <span
                                class="flex items-center justify-center bg-white dark:bg-gray-800 text-sm text-gray-800 dark:text-white font-semibold border-2 border-gray-200 dark:border-gray-700 rounded-full h-10 w-full p-2 text-center">
                                +999 User in our platform
                            </span>
                        </div>
                    </div>
                </div>
